...
function init_sidebar() {
    ...
    $SIDEBAR_MENU.find('a').on('click', function(ev) {
        ...
        if (ev.currentTarget.id === "assignMenu") {
            var scope = angular.element(document.getElementById('assignMenu')).scope();
            scope.openAssignMenu();
        }
        if (ev.currentTarget.id === "cashreconMenu") {
            var scope = angular.element(document.getElementById('cashreconMenu')).scope();
            scope.openCashReconMenu();
        }
    });
...
function formatHoursMins(selectedDate) {
...
$("#validateBtn").click(function() {
    var scope = angular.element(document.getElementById('validateBtn')).scope();
    scope.validateShipmentAssign();
});

$("#validatereconBtn").click(function() {
    var scope = angular.element(document.getElementById('validatereconBtn')).scope();
    scope.validateCashRecon();
});

$('#dsb_img').attr('src', 'assets/images/parsel.png');
$('#dsb_img').css({
    'width': '150px',
    'margin-left': '15px',
    'margin-top': '20px'
...
$("#menu_toggle").click(function() {
    if ($("body").hasClass("nav-sm")) {
        $('#dsb_img').attr('src', 'assets/images/logo.png');
        $('#dsb_img').css({
            'width': '35px',
            'margin-left': '15px',
            'margin-top': '15px',
