...
var pbb2ShipmentsController = myApp.controller('Pbb2ShipmentsController', ['$rootScope', '$scope', '$interval', 'CONSTANT', 'ShipmentService', 'APP', 'DriversService', function($rootScope, $scope, $interval, CONSTANT, ShipmentService, APP, DriversService) {
    ...
    $scope.deleteShipment = function(job) {
        ...
        NProgress.start();
        var input = angular.toJson({
            "shipmentId": job.shipment.shipmentId
        });
