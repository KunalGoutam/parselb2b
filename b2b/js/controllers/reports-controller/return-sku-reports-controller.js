...
var quantumReportsController = myApp.controller('SKUReportsController', ['$rootScope', '$scope', 'DriversService', 'CONSTANT', function($rootScope, $scope, DriversService, CONSTANT) {
    ...
    $scope.getReports = function() {
        ...
        window.open($rootScope.baseUrl + '/adm/dlinfireports/1/' + formatDate($scope.date.fromDate));
    };
